...
const Color cameraFill = Color(0xFF1E5E63);
const Color cameraFillSelected = Color(0xFF2A8C94);
const Color cameraStroke = Color(0xFF3FBCC6);
const Color cameraGhostFill = Color(0x541E5E63);
const Color cameraGhostStroke = Color(0x803FBCC6);
...
const int minCameraDurationMs = 200;
