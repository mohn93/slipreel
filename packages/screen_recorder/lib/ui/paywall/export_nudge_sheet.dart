...
/// remaining free exports stay available. The gate proper is [PaywallSheet],
/// shown only when the trial is exhausted.
class ExportNudgeSheet {
  const ExportNudgeSheet._();
    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text('Nice — your first export is done',
                style: TextStyle(
