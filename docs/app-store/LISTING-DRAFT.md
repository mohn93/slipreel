# Slipreel listing draft

Not submitted. Confirm every feature against the provisioned store build before publication.

Name: Slipreel
Subtitle: Screen recordings, polished
Primary category: Video
Secondary category: Productivity

Promotional text:
Turn screen recordings into clear product demos and tutorials with smooth zooms, cursor effects, backgrounds and webcam framing.

Description:
Slipreel helps you record, edit and share clear screen videos on your Mac.

Capture your screen, a window or a selected area. Add your microphone, system audio or webcam when your recording needs them. Edit the result with smooth zooms, cursor styling, backgrounds, frames and captions, then export your finished video.
